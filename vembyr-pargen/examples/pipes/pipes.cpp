...
Result chunk_expression3;
    Result chunk_operator;
    Result chunk_params;
    Result chunk_params_rest;
    Result chunk_param;
};
...
Result rule_operator(Stream &, const int);
Result rule_params(Stream &, const int);
Result rule_params_rest(Stream &, const int);
Result rule_param(Stream &, const int);
...
Result rule_start(Stream & stream, const int position){
    ...
    Result result_peg_2(myposition);
        std::cout << "Trying rule start at " << myposition << " '" << stream.get(result_peg_2.getPosition()) << "' alternative: expression sw <eof> {{ value = $1; }}" << std::endl;
        {
        ...
        std::cout << "Succeeded rule start at position " << result_peg_2.getPosition() << " alternative: expression sw <eof> {{ value = $1; }}" << std::endl;
        return result_peg_2;
        out_peg_4:
...
Result rule_expression(Stream & stream, const int position){
    ...
    Result result_peg_2(myposition);
        std::cout << "Trying rule expression at " << myposition << " '" << stream.get(result_peg_2.getPosition()) << "' alternative: expression2 expression1_rest($1)" << std::endl;
        {
        ...
        std::cout << "Succeeded rule expression at position " << result_peg_2.getPosition() << " alternative: expression2 expression1_rest($1)" << std::endl;
        return result_peg_2;
        out_peg_4:
...
Result rule_expression1_rest(Stream & stream, const int position, Value a){
    ...
    Result result_peg_2(myposition);
        ...
        Result result_peg_8(myposition);
        {
            ...
            result_peg_8.setValue(Value((void*) "or"));
                for (int i = 0; i < 2; i++){
                    if (compareChar("or"[i], stream.get(result_peg_8.getPosition()))){
        ...
        std::cout << "Trying rule expression1_rest at " << myposition << " '" << stream.get(result_peg_13.getPosition()) << "' alternative: <void> {{ value = a; }}" << std::endl;
        {
        ...
        std::cout << "Succeeded rule expression1_rest at position " << result_peg_13.getPosition() << " alternative: <void> {{ value = a; }}" << std::endl;
...
Result rule_expression2(Stream & stream, const int position){
    ...
    Result result_peg_2(myposition);
        std::cout << "Trying rule expression2 at " << myposition << " '" << stream.get(result_peg_2.getPosition()) << "' alternative: expression3 expression2_rest($1)" << std::endl;
        {
        ...
        std::cout << "Succeeded rule expression2 at position " << result_peg_2.getPosition() << " alternative: expression3 expression2_rest($1)" << std::endl;
        return result_peg_2;
        out_peg_4:
...
Result rule_expression2_rest(Stream & stream, const int position, Value a){
    ...
    RuleTrace trace_peg_9(stream, "expression2_rest");
    int myposition = position;
    ...
    Result result_peg_2(myposition);
        ...
        out_peg_5:
        Result result_peg_8(myposition);
        std::cout << "Trying rule expression2_rest at " << myposition << " '" << stream.get(result_peg_8.getPosition()) << "' alternative: <void>" << std::endl;
        
        stream.update(result_peg_8.getPosition());
        std::cout << "Succeeded rule expression2_rest at position " << result_peg_8.getPosition() << " alternative: <void>" << std::endl;
        return result_peg_8;
    stream.update(errorResult.getPosition());
...
Result rule_expression3(Stream & stream, const int position){
    ...
    RuleTrace trace_peg_11(stream, "expression3");
    int myposition = position;
    
    
    
    Result result_peg_2(myposition);
        std::cout << "Trying rule expression3 at " << myposition << " '" << stream.get(result_peg_2.getPosition()) << "' alternative: operator {{std::cout << \"Found operator\" << std::endl;}}" << std::endl;
        {
        
            result_peg_2 = rule_operator(stream, result_peg_2.getPosition());
                if (result_peg_2.error()){
                    goto out_peg_4;
                }
        ...
        std::cout << "Succeeded rule expression3 at position " << result_peg_2.getPosition() << " alternative: operator {{std::cout << \"Found operator\" << std::endl;}}" << std::endl;
        return result_peg_2;
        out_peg_4:
        Result result_peg_5(myposition);
        std::cout << "Trying rule expression3 at " << myposition << " '" << stream.get(result_peg_5.getPosition()) << "' alternative: \"(\" expression \")\" {{ std::cout << \"Found ()\" << std::endl; }}" << std::endl;
        {
            ...
            result_peg_5 = rule_expression(stream, result_peg_5.getPosition());
        ...
        column_peg_1.chunk1->chunk_expression3 = result_peg_5;
        stream.update(result_peg_5.getPosition());
        
        std::cout << "Succeeded rule expression3 at position " << result_peg_5.getPosition() << " alternative: \"(\" expression \")\" {{ std::cout << \"Found ()\" << std::endl; }}" << std::endl;
        return result_peg_5;
        out_peg_7:
        Result result_peg_10(myposition);
        std::cout << "Trying rule expression3 at " << myposition << " '" << stream.get(result_peg_10.getPosition()) << "' alternative: <void>" << std::endl;
        
        
        if (column_peg_1.chunk1 == 0){
            column_peg_1.chunk1 = new Chunk1();
        }
        column_peg_1.chunk1->chunk_expression3 = result_peg_10;
        stream.update(result_peg_10.getPosition());
        
        std::cout << "Succeeded rule expression3 at position " << result_peg_10.getPosition() << " alternative: <void>" << std::endl;
...
Result rule_operator(Stream & stream, const int position){
    
    Column & column_peg_1 = stream.getColumn(position);
    if (column_peg_1.chunk1 != 0 && column_peg_1.chunk1->chunk_operator.calculated()){
        return column_peg_1.chunk1->chunk_operator;
    }
    
    RuleTrace trace_peg_30(stream, "operator");
    int myposition = position;
    
    
    
    Result result_peg_2(myposition);
        std::cout << "Trying rule operator at " << myposition << " '" << stream.get(result_peg_2.getPosition()) << "' alternative: name \"(\" params? \")\"" << std::endl;
        {
        
            {
                    int position_peg_6 = result_peg_2.getPosition();
                    {
                        ...
                        result_peg_2.reset();
                            do{
                                Result result_peg_19(result_peg_2.getPosition());
                                {
                                    ...
                                    char letter_peg_25 = stream.get(result_peg_19.getPosition());
                                    if (letter_peg_25 != '\0' && strchr("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz", letter_peg_25) != NULL){
                                        result_peg_19.nextPosition();
                                        result_peg_19.setValue(Value((void*) (long) letter_peg_25));
                                    } else {
                        ...
                        Result result_peg_17 = result_peg_2;
                        
                        {
                                Value value((void*) 0);
                                std::ostringstream total;
                                		for (Value::iterator it = result_peg_17.getValues().getValues().begin(); it !=	result_peg_17.getValues().getValues().end(); it++){
                                			const Value & v = *it;
            ...
            int save_peg_29 = result_peg_2.getPosition();
                
                result_peg_2 = rule_params(stream, result_peg_2.getPosition());
                if (result_peg_2.error()){
                    
                    result_peg_2 = Result(save_peg_29);
                    result_peg_2.setValue(Value((void*) 0));
        ...
        column_peg_1.chunk1->chunk_operator = result_peg_2;
        stream.update(result_peg_2.getPosition());
        
        std::cout << "Succeeded rule operator at position " << result_peg_2.getPosition() << " alternative: name \"(\" params? \")\"" << std::endl;
        return result_peg_2;
        out_peg_26:
        ...
        column_peg_1.chunk1->chunk_operator = errorResult;
        stream.update(errorResult.getPosition());
...
Result rule_params(Stream & stream, const int position){
    
    Column & column_peg_1 = stream.getColumn(position);
    if (column_peg_1.chunk1 != 0 && column_peg_1.chunk1->chunk_params.calculated()){
        return column_peg_1.chunk1->chunk_params;
    }
    
    RuleTrace trace_peg_6(stream, "params");
    int myposition = position;
    
    
    
    Result result_peg_2(myposition);
        std::cout << "Trying rule params at " << myposition << " '" << stream.get(result_peg_2.getPosition()) << "' alternative: param {{ std::cout << \"Found param\" << std::endl;}} params_rest" << std::endl;
        {
        
            result_peg_2 = rule_param(stream, result_peg_2.getPosition());
                if (result_peg_2.error()){
                    goto out_peg_4;
                }
            ...
            result_peg_2 = rule_params_rest(stream, result_peg_2.getPosition());
                if (result_peg_2.error()){
                    goto out_peg_4;
                }
        ...
        column_peg_1.chunk1->chunk_params = result_peg_2;
        stream.update(result_peg_2.getPosition());
        
        std::cout << "Succeeded rule params at position " << result_peg_2.getPosition() << " alternative: param {{ std::cout << \"Found param\" << std::endl;}} params_rest" << std::endl;
        return result_peg_2;
        out_peg_4:
        ...
        column_peg_1.chunk1->chunk_params = errorResult;
        stream.update(errorResult.getPosition());
...
Result rule_params_rest(Stream & stream, const int position){
    
    Column & column_peg_1 = stream.getColumn(position);
    if (column_peg_1.chunk1 != 0 && column_peg_1.chunk1->chunk_params_rest.calculated()){
        return column_peg_1.chunk1->chunk_params_rest;
    }
    
    RuleTrace trace_peg_7(stream, "params_rest");
    int myposition = position;
    
    
    
    Result result_peg_2(myposition);
        std::cout << "Trying rule params_rest at " << myposition << " '" << stream.get(result_peg_2.getPosition()) << "' alternative: \",\" params {{ std::cout << \"Found more params\" << std::endl;}}" << std::endl;
        {
            ...
            {
                    Value value((void*) 0);
                    std::cout << "Found more params" << std::endl;
                    result_peg_2.setValue(value);
                }
        ...
        column_peg_1.chunk1->chunk_params_rest = result_peg_2;
        stream.update(result_peg_2.getPosition());
        
        std::cout << "Succeeded rule params_rest at position " << result_peg_2.getPosition() << " alternative: \",\" params {{ std::cout << \"Found more params\" << std::endl;}}" << std::endl;
        return result_peg_2;
        out_peg_4:
        Result result_peg_6(myposition);
        std::cout << "Trying rule params_rest at " << myposition << " '" << stream.get(result_peg_6.getPosition()) << "' alternative: <void>" << std::endl;
        
        
        if (column_peg_1.chunk1 == 0){
            column_peg_1.chunk1 = new Chunk1();
        }
        column_peg_1.chunk1->chunk_params_rest = result_peg_6;
        stream.update(result_peg_6.getPosition());
        
        std::cout << "Succeeded rule params_rest at position " << result_peg_6.getPosition() << " alternative: <void>" << std::endl;
        return result_peg_6;
    
        if (column_peg_1.chunk1 == 0){
            column_peg_1.chunk1 = new Chunk1();
        }
        column_peg_1.chunk1->chunk_params_rest = errorResult;
        stream.update(errorResult.getPosition());
...
Result rule_param(Stream & stream, const int position){
    
    Column & column_peg_1 = stream.getColumn(position);
    if (column_peg_1.chunk1 != 0 && column_peg_1.chunk1->chunk_param.calculated()){
        return column_peg_1.chunk1->chunk_param;
    }
    
    RuleTrace trace_peg_26(stream, "param");
    int myposition = position;
    
    
    
    Result result_peg_2(myposition);
        std::cout << "Trying rule param at " << myposition << " '" << stream.get(result_peg_2.getPosition()) << "' alternative: number" << std::endl;
        {
        ...
        column_peg_1.chunk1->chunk_param = result_peg_2;
        stream.update(result_peg_2.getPosition());
        
        std::cout << "Succeeded rule param at position " << result_peg_2.getPosition() << " alternative: number" << std::endl;
        return result_peg_2;
        out_peg_25:
        ...
        column_peg_1.chunk1->chunk_param = errorResult;
        stream.update(errorResult.getPosition());
